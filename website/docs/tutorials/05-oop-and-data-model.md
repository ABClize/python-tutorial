...
本章先讲类、实例、封装、组合与继承，再讲 `dataclass`、特殊方法、描述器和属性查找顺序。
...
- [描述器、属性查找与 __slots__](./05-oop-and-data-model/descriptors-attribute-lookup-slots)
  学习属性查找顺序、数据描述器、非数据描述器和 `__slots__`。

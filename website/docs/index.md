...
每篇教程都对应仓库中的可运行 Python 示例。可以按照目录顺序阅读，也可以直接选择需要的主题。
...
<div class="tutorial-index">
  ...
  <a href="./tutorials/01-basic-types-and-truthiness">
    ...
    <span><strong>变量、基本类型与控制语句</strong><small>从赋值开始，认识值、类型、运算和程序执行顺序。</small></span>
  </a>
  ...
  <a href="./tutorials/03-functions-and-generators">
    ...
    <span><strong>函数、闭包与生成器</strong><small>理解函数调用、作用域，以及生成器为何能暂停和恢复。</small></span>
  </a>
  <a href="./tutorials/04-containers-and-sorting">
    <span class="index-number">04</span>
    <span><strong>容器、推导式与排序</strong><small>根据数据关系选择容器，并正确处理排序与去重。</small></span>
  </a>
  <a href="./tutorials/05-oop-and-data-model">
    <span class="index-number">05</span>
    <span><strong>面向对象与数据模型</strong><small>从类和实例读到继承、特殊方法、描述符和属性查找。</small></span>
  </a>
  <a href="./tutorials/06-exceptions-and-context-managers">
    <span class="index-number">06</span>
    <span><strong>异常与上下文管理器</strong><small>理解失败怎样传播，以及资源为何能在退出时可靠释放。</small></span>
  </a>
  <a href="./tutorials/07-typing-and-protocols">
    <span class="index-number">07</span>
    <span><strong>类型标注、泛型与 Protocol</strong><small>区分静态契约与运行时校验，表达数据和接口关系。</small></span>
  </a>
  <a href="./tutorials/08-standard-library-patterns">
    <span class="index-number">08</span>
    <span><strong>常用标准库模式</strong><small>按实际问题选择路径、数据处理、迭代与缓存工具。</small></span>
  </a>

  <div class="index-group-label">算法、性能与测试</div>
  <a href="./tutorials/09-algorithms-and-complexity">
    <span class="index-number">09</span>
    <span><strong>算法正确性与复杂度</strong><small>从增长趋势和循环不变量理解算法为什么正确、代价多大。</small></span>
  </a>
  <a href="./tutorials/10-performance-and-memory">
    <span class="index-number">10</span>
    <span><strong>性能分析与内存模型</strong><small>用基准、profiler 和内存快照建立可重复的证据。</small></span>
  </a>
  <a href="./tutorials/11-testing-and-mocking">
    <span class="index-number">11</span>
    <span><strong>测试、依赖注入与 Mock</strong><small>从基本断言走到 fixture、测试替身和不同测试层次。</small></span>
  </a>
  ...
  <a href="./tutorials/13-asyncio-task-timeline">
    ...
    <span><strong>asyncio 任务时间线</strong><small>区分协程与 Task，看懂并发等待、超时和取消传播。</small></span>
  </a>

  <div class="index-group-label">后端工程</div>
  <a href="./tutorials/14-fastapi-layered-backend">
    <span class="index-number">14</span>
    <span><strong>FastAPI 分层后端</strong><small>跟踪一次请求怎样穿过 HTTP、服务、领域和持久化边界。</small></span>
  </a>
  <a href="./tutorials/15-pydantic-v2-data-boundaries">
    <span class="index-number">15</span>
    <span><strong>Pydantic v2 与数据边界</strong><small>理解外部数据怎样被解析、验证、规范化和序列化。</small></span>
  </a>
  <a href="./tutorials/16-async-reliability-patterns">
    <span class="index-number">16</span>
    <span><strong>异步可靠性模式</strong><small>组合超时、重试、并发限制、背压和故障隔离。</small></span>
  </a>
</div>
